...
public class PlayerPresets
{
    ...
    public static PlayerPresets Slow = new(10f, 5f, 20f, 12f,29.4f, 250f,3f,2f);
    public static PlayerPresets Mid = new(10f, 5f, 20f, 12f,29.4f, 250f,1f,2f);
    public static PlayerPresets Swift = new(10f, 5f, 20f, 12f,29.4f, 250f,3f,2f);
}
