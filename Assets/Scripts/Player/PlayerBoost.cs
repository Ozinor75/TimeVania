...
public class PlayerPresets
{
    ...
    public static PlayerPresets Slow = new(14f, 5f, 20f, 12f,29.4f, 250f,3f,2f);
    public static PlayerPresets Mid = new(14f, 5f, 20f, 12f,29.4f, 250f,1f,2f);
    public static PlayerPresets Swift = new(14f, 5f, 20f, 12f,29.4f, 250f,3f,2f);
}
