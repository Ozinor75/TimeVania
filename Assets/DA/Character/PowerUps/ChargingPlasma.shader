...
Shader "ChargingPlasma"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 appendResult32 = (float2(( mulTime25 * 1.5 ) , 0.02));
			float2 uv_TexCoord31 = i.uv_texcoord * float2( 0.17,1 ) + appendResult32;
			float2 appendResult33 = (float2(( mulTime25 * 4.0 ) , 0.02));
			float2 uv_TexCoord30 = i.uv_texcoord * float2( 0.2,0.9 ) + appendResult33;
			float2 appendResult48 = (float2(( mulTime25 * 2.5 ) , -0.05));
			float2 uv_TexCoord49 = i.uv_texcoord * float2( 0.05,0.34 ) + appendResult48;
			float2 uv_TexCoord57 = i.uv_texcoord * float2( 0.2,0.26 ) + appendResult33;
			float Bolt27 = ( ( tex2D( _Bolt1, uv_TexCoord31 ).r * 0.8 ) + ( tex2D( _Bolt2, uv_TexCoord30 ).r * 0.9 ) + ( tex2D( _Bolt3, uv_TexCoord49 ).r * 0.7 ) + ( tex2D( _Bolt4, uv_TexCoord57 ).r * 1.0 ) );
			float4 color43 = IsGammaSpace() ? float4(4,4,4,1) : float4(21.11213,21.11213,21.11213,1);
			float4 blendOpSrc62 = appendResult46;
			float4 blendOpDest62 = ( Bolt27 * color43 );
			float4 temp_output_62_0 = ( saturate( min( blendOpSrc62 , blendOpDest62 ) ));
			float2 appendResult65 = (float2(( _CosTime.w * 512.0 * _SinTime.w ) , 0.0));
			...
			o.Emission = ( temp_output_62_0 + ( appendResult46 * saturate( min( break16_g1.x , break16_g1.y ) ) ) ).rgb;
...
/*ASEBEGIN
Version=19200
Node;AmplifyShaderEditor.SimpleAddOpNode;21;490.5186,-1575.447;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;462.6215,-966.5242;Inherit;False;Property;_Beam;Beam;5;1;[HDR];Create;True;0;0;0;False;0;False;0.5531816,0,1,1;0.5516109,20.86591,15.62897,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;218.8006,-1153.705;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.7;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;26;-103.5509,-1815.772;Inherit;True;Property;_Bolt1;Bolt1;1;0;Create;True;0;0;0;False;0;False;-1;688a57e387def8f4197eeeae84564b86;1af91318c0b861b4fa5d1fe46d400630;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;29;-113.484,-1604.403;Inherit;True;Property;_Bolt2;Bolt2;2;0;Create;True;0;0;0;False;0;False;-1;942d27e6ad5150040bb5f55937b8ff7c;8a285a892da13e54a804c8d53b0c9ddd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-379.5768,-1705.599;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.17,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;32;-564.1166,-1572.646;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0.02;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;33;-570.1965,-1446.088;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0.02;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;49;-379.3665,-1211.722;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.05,0.34;False;1;FLOAT2;0,0.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;48;-583.332,-1220.522;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;-0.05;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;47;-755.4898,-1232.479;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;50;-98.51953,-1187.136;Inherit;True;Property;_Bolt3;Bolt3;3;0;Create;True;0;0;0;False;0;False;-1;942d27e6ad5150040bb5f55937b8ff7c;f80c56b9c5d2bee478895c97dd3b0f7b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CosTime;71;-131.1469,-117.918;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;131.8929,-190.4071;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;512;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;42;1939.219,-349.1577;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;73;1558.853,-180.918;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=F54F5FD6DEA8CFEAE2C7A438D0C50DAE4F6330A8