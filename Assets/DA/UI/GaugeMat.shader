    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            UNITY_INSTANCING_BUFFER_START(GaugeMat)
            	UNITY_DEFINE_INSTANCED_PROP(float4, _Base_ST)
#define _Base_ST_arr GaugeMat
...
#define _TimeScale_arr GaugeMat
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float smoothstepResult57 = smoothstep( 0.1 , 0.2 , 0.0);
                ...
                float4 _Base_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(_Base_ST_arr, _Base_ST);
                float2 uv_Base = IN.texcoord.xy * _Base_ST_Instance.xy + _Base_ST_Instance.zw;
                ...
                half4 color = ( ( ( ( ( _ActiveLevel_Instance == _TotalLevel_Instance ? _SuperChargedColor : _BaseColor ) * smoothstepResult57 ) + float4( 0,0,0,1 ) ) * saturate( min( break16_g6.x , break16_g6.y ) ) * tex2D( _Base, uv_Base ) ) + SampleGradient( gradient99, ( ( temp_output_18_0 - 1.0 ) * 0.0 ) ) );
...
Node;AmplifyShaderEditor.Vector2Node;10;-299.5036,-186.8808;Inherit;False;InstancedProperty;_InitialSize;InitialSize;4;0;Create;True;0;0;0;False;0;False;1,1;1,0.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-2387.013,148.3929;Inherit;False;InstancedProperty;_ActiveLevel;ActiveLevel;6;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-2366.013,260.3929;Inherit;False;InstancedProperty;_TotalLevel;TotalLevel;5;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;93;-77.38959,868.0226;Inherit;True;Property;_FX_Debug;FX_Debug;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;652.672,-191.348;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;64;78.01001,79.09178;Inherit;True;Rectangle;-1;;6;6b23e0c975270fb4084c354b2c83366a;0;3;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;57;-276.4596,-832;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.1;False;2;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;101;-672.0797,-639.6243;Inherit;True;Property;_Base;Base;8;0;Create;True;0;0;0;False;0;False;-1;4336ccfe5fdae814c9a02e7653bff6cf;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;25;-996.3278,900.619;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;102;-955.0806,-1108.9;Inherit;True;Property;_Base1;Base;9;0;Create;True;0;0;0;False;0;False;-1;ddc70fc7a4a640a46a84f0f53ca67172;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;103;-959.696,-887.7316;Inherit;True;Property;_Base2;Base;10;0;Create;True;0;0;0;False;0;False;-1;93ac6598462c00e4ab826f0168300597;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;61;-1266.707,-1047.025;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;107;-1268.851,-787.0792;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;108;-1439.518,-753.7458;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;105;-1448.082,-1206.36;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;104;-1877.06,-1102.884;Inherit;False;1;0;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;-1688.456,-737.4402;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinTimeNode;111;-2007.123,-980.1067;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;113;-1839.123,-982.1066;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;100;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;115;-1648.456,-1018.106;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;1;FLOAT;0
...
WireConnection;113;0;111;4
WireConnection;115;0;113;0
ASEEND*/
//CHKSM=4EF840749782CD2F9179609321EAFB9C420F1C6C